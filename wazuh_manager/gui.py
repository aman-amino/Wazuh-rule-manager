...
class App(ctk.CTk):
    ...
    def add_rule(self):
        ...
        dialog = RuleDialog(self, title="Add New Rule")
    ...
    def edit_rule(self):
        ...
        dialog = RuleDialog(self, title="Edit Rule", initial_data=rule_data)
        self.wait_window(dialog)
...
class RuleDialog(ctk.CTkToplevel):
    def __init__(self, parent, title="Rule Dialog", initial_data=None):
        ...
        for i, field in enumerate(fields):
            ...
            if initial_data:
                ...
                # Handle cases where level is rule_level
                alt_key = f"rule_{key}"
                if key in initial_data:
                    entry.insert(0, str(initial_data[key]))
                elif alt_key in initial_data:
                    entry.insert(0, str(initial_data[alt_key]))
                elif field == "Rule ID" and "rule_id" in initial_data:
                    entry.insert(0, str(initial_data["rule_id"]))
